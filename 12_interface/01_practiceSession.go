...
func main() {
	serverOne := Server{"Node-A", 85.5, 16.0, 65.0, true}
	serverTwo := Server{"Node-B", 55.0, 8.0, 59.0, true}
	serverThree := Server{"Node-C", 0, 0, 0, false}
	printBanner()
	serverOne.PrintReport()
	serverTwo.PrintReport()
	serverThree.PrintReport()
	serverThree.Start()
	fmt.Println("After Restart the Server", serverThree.Status())
